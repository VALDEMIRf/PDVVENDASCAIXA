...
Public Class frmLancamentoContasReceber
    ...
    Private Sub btnExcluir_Click(sender As Object, e As EventArgs) Handles btnExcluir.Click
        ...
        If txtNDoc.Text <> "" Then
            ...
            Try
                ...
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.AddWithValue("@id_contaReceber", txtCodigo.Text)
                cmd.Parameters.Add("@mensagem", SqlDbType.VarChar, 100).Direction = 2
                cmd.ExecuteNonQuery()
    ...
    Private Sub txtNumeroPacelas_ValueChanged(sender As Object, e As EventArgs) Handles txtNumeroPacelas.ValueChanged
    ...
    Private Sub btBaixarConta_Click(sender As Object, e As EventArgs) Handles btBaixarConta.Click
        ...
        Try
            ...
            cmd = New SqlCommand("pa_ContasRecebidas_Salvar", con)
            cmd.CommandType = CommandType.StoredProcedure
            cmd.Parameters.AddWithValue("@numDocto", txtNDoc.Text)
