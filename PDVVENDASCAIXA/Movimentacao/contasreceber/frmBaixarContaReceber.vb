...
Public Class frmBaixarContaReceber
    ...
    Private Sub frmBaixarContaReceber_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        CarregarDGrid()
    End Sub
    ...
    Private Sub CarregarDGrid()
        ...
        Try
            ...
            'da = New SqlDataAdapter("pa_ParcelasReceber_lista2", con)
            da = New SqlDataAdapter("pa_ParcelasReceber_lista2", con)
    ...
    Sub ultimoValor()
        ...
        Else
            ...
            Try
                ...
                Dim sql As String = "pa_ParcelasRecebersValorRestante " & CInt(numIDParcela2)
                Dim cmd As SqlCommand = New SqlCommand(sql, con)
                dr = cmd.ExecuteReader(CommandBehavior.SingleRow)
    ...
    Private Sub FormatarDG()
        ...
        With dgvParcelas
            ...
            .Columns(12).HeaderText = "Juros"
            .Columns(13).HeaderText = "Desconto"
            .Columns(14).HeaderText = "id_cliente"
            .Columns(15).HeaderText = "idConta"
