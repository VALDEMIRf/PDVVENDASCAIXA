...
Public Class frmLancamentoContasReceber
    ...
    Private Sub btGerarParcelas_Click(sender As Object, e As EventArgs) Handles btGerarParcelas.Click
        ...
        Try
            ...
            For i = 0 To Val(txtNumeroPacelas.Text) - 1
                ...
                dgvParcelas.Rows.Add(txtCodigo.Text, i + 1, Mid(novaParcela.ToString, 1, 10), FormatCurrency(valorParcela), txtNDoc.Text, situacaoPagto, FormatCurrency(ValorTotal), txtSituacao.Text, txtSaldoRestante.Text, txtCliente.SelectedValue, lblCodigoConta.Text)
    ...
    Public Sub atualizarSituacao()
        ...
        Try
            abrir()
            cmd = New SqlCommand("pa_ContasReceber_EditarSituacao", con)
            cmd.CommandType = CommandType.StoredProcedure
    ...
    Private Sub txtValorParcelas_TextChanged(sender As Object, e As EventArgs) Handles txtValorParcelas.TextChanged
    ...
    Private Sub txtNumeroPacelas_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtNumeroPacelas.KeyPress
