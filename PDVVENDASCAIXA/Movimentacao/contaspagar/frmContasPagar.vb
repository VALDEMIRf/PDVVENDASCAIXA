...
Public Class frmContasPagar
    ...
    Private Sub CalculaContas()
        ...
        For Each linha As DataGridViewRow In dgContasPagar.Rows
            ...
            dblTotalContas = dblTotalContas + linha.Cells(6).Value

            'Total Contas Pagas
            If linha.Cells("situacao").Value = "Paga" Then
                dblContasPagas = dblContasPagas + linha.Cells(6).Value
            End If

            'Total Contas Não Pagas
            If linha.Cells("situacao").Value = "Não Paga" Then
                dblContasNaoPagas = dblContasNaoPagas + linha.Cells(6).Value
            End If
